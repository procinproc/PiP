...
PIP_LDFLAGS_TO_INSTALL = \
		-L$(top_builddir)/lib -Wl,-rpath=$(libdir) $(GLIBC_LDFLAGS) -lpip -ldl $(PTHREAD_FLAG)
...
PIP_LDFLAGS_BOTH_TO_INSTALL = $(PIP_LDFLAGS_TO_INSTALL) $(RDYNAMIC_FLAG) $(DYLINKER_FLAG) $(PTHREAD_FLAG) $(PIE_LDFLAG)
